...
formatter.scenario({
  "name": "Create Company with already exist project name",
  "description": "",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.step({
  "name": "verify already exist company message displayed to the user",
  "keyword": "Then "
});
formatter.match({
  "location": "createCompany.companyexistalertmessage()"
});
formatter.result({
  "status": "passed"
});
...
formatter.scenario({
  "name": "Verify Create Company field validation",
  "description": "",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.step({
  "name": "user enters invalid \"asdfasdfasf\" as email id",
  "keyword": "When "
});
formatter.match({
  "location": "createCompany.invalid_enters_as_email_id(String)"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "user enters invalid \"123\" as PAN details",
  "keyword": "When "
});
formatter.match({
  "location": "createCompany.invalid_PAN_details(String)"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "user enters invalid \"123\" as TIN details",
  "keyword": "When "
});
formatter.match({
  "location": "createCompany.invalid_TIN_details(String)"
});
formatter.result({
  "status": "passed"
});
